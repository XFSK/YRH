...
void AOnlinePlayerHUD::DrawCrosshair(UTexture2D* Texture, FVector2D ViewportCenter,FVector2D Spread,FLinearColor CrosshairsColor)
{
...
void AOnlinePlayerHUD::AddPlayerOverlap()
{
	APlayerController* PlayerController = GetOwningPlayerController();
	if(PlayerController && PlayerOverlapClass)
	{
